...
Created by: VineetC137
GitHub: https://github.com/VineetC137/UnThinkable-AI-Meeting-Summarizer

An intelligent meeting summarization tool that combines whisper.cpp for speech-to-text
and Ollama for AI-powered summarization, wrapped in a user-friendly Gradio interface.
"""
...
if __name__ == "__main__":
    ...
    iface = gr.Interface(
        ...
        title="UnThinkable AI Meeting Summarizer",
        description="🚀 Transform your meeting recordings into intelligent summaries with cutting-edge AI technology. Built by VineetC137.",
    )
